...
type Record struct {
	...
	PartitionKey         uint64   `protobuf:"varint,5,opt,name=partition_key,json=partitionKey,proto3" json:"partition_key,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *Record) GetPartitionKey() uint64 {
	if m != nil {
...
var fileDescriptor_555bd8c177793206 = []byte{
	...
	,
}
	...
	for iNdEx < l {
		...
		case 5:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.PartitionKey |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
