...
type TaskInfo struct {
	...
	ScheduleSatelliteName string         `protobuf:"bytes,3,opt,name=schedule_satellite_name,json=scheduleSatelliteName,proto3" json:"schedule_satellite_name,omitempty"`
	Phase                 TaskInfo_Phase `protobuf:"varint,4,opt,name=phase,proto3,enum=messenger.TaskInfo_Phase" json:"phase,omitempty"`
	XXX_NoUnkeyedLiteral  struct{}       `json:"-"`
	XXX_unrecognized      []byte         `json:"-"`
	XXX_sizecache         int32          `json:"-"`
}
...
func (m *TaskInfo) GetScheduleSatelliteName() string {
	if m != nil {
		return m.ScheduleSatelliteName
	}
	return ""
}
...
var fileDescriptor_84c0905e918bfd6e = []byte{
	...
	,
}
...
func (m *TaskInfo) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.ScheduleSatelliteName) > 0 {
		i -= len(m.ScheduleSatelliteName)
		copy(dAtA[i:], m.ScheduleSatelliteName)
		i = encodeVarintInfos(dAtA, i, uint64(len(m.ScheduleSatelliteName)))
		i--
		dAtA[i] = 0x1a
	}
...
func (m *TaskInfo) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ScheduleSatelliteName", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.ScheduleSatelliteName = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 4:
			if wireType != 0 {
