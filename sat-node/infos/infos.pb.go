...
type NodeInfo struct {
	...
	CanScheduled         bool      `protobuf:"varint,7,opt,name=can_scheduled,json=canScheduled,proto3" json:"can_scheduled,omitempty"`
	CurrentTerm          uint64    `protobuf:"varint,8,opt,name=current_term,json=currentTerm,proto3" json:"current_term,omitempty"`
	XXX_NoUnkeyedLiteral struct{}  `json:"-"`
	XXX_unrecognized     []byte    `json:"-"`
	XXX_sizecache        int32     `json:"-"`
}
...
func (m *NodeInfo) GetCanScheduled() bool {
	if m != nil {
		return m.CanScheduled
	}
	return false
}

func (m *NodeInfo) GetCurrentTerm() uint64 {
	if m != nil {
...
var fileDescriptor_84c0905e918bfd6e = []byte{
	...
	,
}
...
func (m *NodeInfo) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.CurrentTerm != 0 {
		i = encodeVarintInfos(dAtA, i, uint64(m.CurrentTerm))
		i--
		dAtA[i] = 0x40
	}
	if m.CanScheduled {
...
func (m *NodeInfo) Size() (n int) {
	...
	if m.CurrentTerm != 0 {
		n += 1 + sovInfos(uint64(m.CurrentTerm))
	}
	if m.XXX_unrecognized != nil {
		n += len(m.XXX_unrecognized)
	}
...
func (m *NodeInfo) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 7:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field CanScheduled", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
