...
type SubmitJobRequest struct {
	...
	YamlByte             []byte   `protobuf:"bytes,3,opt,name=yaml_byte,json=yamlByte,proto3" json:"yaml_byte,omitempty"`
...
func (m *SubmitJobRequest) GetYamlByte() []byte {
	if m != nil {
		return m.YamlByte
	}
	return nil
...
var fileDescriptor_df5d86f47d451473 = []byte{
	...
	,
}
...
func (m *SubmitJobRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.YamlByte) > 0 {
		i -= len(m.YamlByte)
		copy(dAtA[i:], m.YamlByte)
		i = encodeVarintSun(dAtA, i, uint64(len(m.YamlByte)))
		i--
		dAtA[i] = 0x1a
	}
...
func (m *SubmitJobRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field YamlByte", wireType)
			}
			var byteLen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.YamlByte = append(m.YamlByte[:0], dAtA[iNdEx:postIndex]...)
			if m.YamlByte == nil {
				m.YamlByte = []byte{}
			}
			iNdEx = postIndex
